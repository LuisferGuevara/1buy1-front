...
function ExpandedCard({ product, onCollapse }) {
  ...
  let minUd = supermarkets.reduce((prev, curr) =>
    prev.priceUd < curr.priceUd ? prev : curr
  ).priceUd;
  let minKg = supermarkets.reduce((prev, curr) =>
    prev.priceKg < curr.priceKg ? prev : curr
  ).priceKg;
        ...
        <div className="card--button">
          ...
          {token && (
            <div className="cart-logo">
              <img
                src="https://res.cloudinary.com/dfxn0bmo9/image/upload/v1670265008/icons/addToCart-yellow-10_qyg1bb.svg"
