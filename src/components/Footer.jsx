    ...
    <footer>
      <div className="footer1">
        <div className="footer1--social">
          <NavLink to="/" rel="noreffered" className="footer1--social__logo">
            <img src="https://res.cloudinary.com/dfxn0bmo9/image/upload/v1669916552/icons/1buy1-logo1-03_glar7y.svg" alt="logo" />
          </NavLink>
          <ul className="footer1--social__list">
            ...
            <li>
                <a href="twitter">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="twitter" viewBox="0 0 16 16">
            ...
            <li>
                <a href="linkedin">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="linkedin" viewBox="0 0 16 16">
      ...
      <div className="footer--policies">
        <ul className="footer--policies__list">
